...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-bull/node_modules/bull/lib/timer-manager.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-bull/node_modules/bull/lib/timer-manager.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-bull/node_modules/bull/lib/</a> &#187; timer-manager.js</div>
</div>
<div class="body">
...
*/
TimerManager.prototype.set = <span class="fstat-no" title="function not covered" >function(name, delay, fn){</span>
<span class="cstat-no" title="statement not covered" >  var id = uuid.v4();</span>
<span class="cstat-no" title="statement not covered" >  var now = Date.now();</span>
<span class="cstat-no" title="statement not covered" >  var timer = setTimeout(<span class="fstat-no" title="function not covered" >function (timerInstance, timeoutId) {</span></span>
<span class="cstat-no" title="statement not covered" >    timerInstance.clear(timeoutId);</span>
...
<span class="cstat-no" title="statement not covered" >  this.timers[id] = {</span>
    name: name,
    created: now,
    timer: timer
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.idle = false;</span>
...
&nbsp;
  ...
  remaining timers
*/
TimerManager.prototype.clear = <span class="fstat-no" title="function not covered" >function(id){</span>
<span class="cstat-no" title="statement not covered" >  var timers = this.timers;</span>
<span class="cstat-no" title="statement not covered" >  var timer = timers[id];</span>
<span class="cstat-no" title="statement not covered" >  if(!timer) {</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
<span class="cstat-no" title="statement not covered" >  clearTimeout(timer.timer);</span>
<span class="cstat-no" title="statement not covered" >  delete timers[id];</span>
<span class="cstat-no" title="statement not covered" >  if(!this.idle &amp;&amp; (_.size(timers) === 0)){</span>
<span class="cstat-no" title="statement not covered" >    while(this.listeners.length){</span>
<span class="cstat-no" title="statement not covered" >      this.listeners.pop()();</span>
    }
<span class="cstat-no" title="statement not covered" >    this.idle = true;</span>
  }
};
&nbsp;
TimerManager.prototype.clearAll = <span class="fstat-no" title="function not covered" >function(){</span>
<span class="cstat-no" title="statement not covered" >  var _this = this;</span>
<span class="cstat-no" title="statement not covered" >  _.each(this.timers, <span class="fstat-no" title="function not covered" >function(timer, id){</span></span>
<span class="cstat-no" title="statement not covered" >    _this.clear(id);</span>
  });
};
&nbsp;
/**
...
*/
TimerManager.prototype.whenIdle = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var _this = this;</span>
...
<span class="cstat-no" title="statement not covered" >    if(_this.idle) {</span>
<span class="cstat-no" title="statement not covered" >      resolve();</span>
    } else{
<span class="cstat-no" title="statement not covered" >      _this.listeners.unshift(resolve);</span>
    }
  });
};
&nbsp;
